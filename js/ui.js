      ...
      card.innerHTML = `
        ...
        <div class="software-body">
          ...
          <div style="display:flex;flex-wrap:wrap;gap:0.4rem;margin-top:0.2rem;">
            <a href="${item.url}" target="_blank" rel="noopener" style="color:var(--accent);text-decoration:none;font-weight:600;font-size:0.85rem;">🖥️</a>
            ${item.download ? `<a href="${item.download}" target="_blank" rel="noopener" style="color:var(--accent);text-decoration:none;font-weight:600;font-size:0.85rem;">💾</a>` : ""}
          </div>
